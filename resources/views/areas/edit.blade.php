        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <textarea name="address" id="address" cols="30" rows="2" placeholder="INGRESE DIRECCION CORTA" autofocus autocomplete="address" class="form-control">{{ $area->address }}</textarea>
                    @error('address')
                        <span style="color: red;"> • {{ $message }} </span><br/>
                    @enderror
                </div>
